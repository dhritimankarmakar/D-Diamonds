                ...
                <div id="products-collections-filter" class="row">
                        ...
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img13.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover13.jpg"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img14.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover14.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img15.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover15.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img16.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover16.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img17.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover17.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img18.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover18.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img7.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover7.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img8.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover8.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img9.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover9.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img10.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover10.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img11.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover11.jpg"
                                        class="hover-image" alt="image">
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 products-col-item">
                        <div class="products-box">
                            <div class="products-image">
                                <a href="products-type-1.html">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img12.jpg" class="main-image"
                                        alt="image">
                                    <img src="<?= base_url('public/') ?>assets/img/products/img-hover12.jpg"
                                        class="hover-image" alt="image">
                                </a>
