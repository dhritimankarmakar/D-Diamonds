    ...
    <div class="container">
        <div class="signup-content">
            ...
            <?php if ($session->getFlashdata('msg') !== null): ?>
                ...
                <div class="alert alert-<?= $session->getFlashdata('msg')['type'] ?> alert-dismissible fade show"
                    role="alert">
                    <div>
            ...
            <?php if ($session->getFlashdata('msg') !== null): ?>
                <!-- <div class="alert alert-<?= $session->getFlashdata('msg')['type'] ?> alert-dismissible fade show d-flex justify-content-between"
                    role="alert">
                    <div>
                        <?= $session->getFlashdata('msg')['msg'] ?>
                    </div>
            ...
            <form class="signup-form" action="<?= base_url('/signup') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="form-group">
                    <label>First Name</label>
                    <input type="text" class="form-control" placeholder="Enter your first name" id="first_name"
                        name="first_name" value="<?= esc(set_value('first_name')) ?>">
                    <span class="text-danger">
                        <?php if (!empty($session->get('invalid_creds')['errors']['first_name'])): ?>
                            <?= $session->get('invalid_creds')['errors']['first_name'] ?>
                        <?php endif; ?>
                    </span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter your last name" id="last_name"
                        name="last_name" value="<?= esc(set_value('last_name')) ?>">
                    <span class="text-danger">
                        <?php if (!empty($session->get('invalid_creds')['errors']['last_name'])): ?>
                            <?= $session->get('invalid_creds')['errors']['last_name'] ?>
                        <?php endif; ?>
                    </span>
                </div>
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input class="form-control" placeholder="Enter your email" id="email" name="email"
                        value="<?= esc(set_value('email')) ?>">
                    <span class="text-danger">
                        <?php if (!empty($session->get('invalid_creds')['errors']['email'])): ?>
                            <?= $session->get('invalid_creds')['errors']['email'] ?>
                        <?php endif; ?>
                    </span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Enter your phone no." id="phone_no" name="phone_no"
                        value="<?= esc(set_value('phone_no')) ?>">
                    <span class="text-danger">
                        <?php if (!empty($session->get('invalid_creds')['errors']['phone_no'])): ?>
                            <?= $session->get('invalid_creds')['errors']['phone_no'] ?>
                        <?php endif; ?>
                    </span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="Enter your password" id="password"
                        name="password" value="<?= esc(set_value('password')) ?>">
                    <span class="text-danger">
                        <?php if (!empty($session->get('invalid_creds')['errors']['password'])): ?>
                            <?= $session->get('invalid_creds')['errors']['password'] ?>
                        <?php endif; ?>
                    </span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="Enter your password" id="password"
                        name="passconf" value="<?= esc(set_value('password')) ?>">
                    <span class="text-danger">
                        <?php if (!empty($session->get('invalid_creds')['errors']['passconf'])): ?>
                            <?= $session->get('invalid_creds')['errors']['passconf'] ?>
                        <?php endif; ?>
                    </span>
                </div>
                ...
                <a href="<?= base_url('/') ?>" class="return-store">or Return to Store</a>
            </form>
        </div>
    </div>
</section>
